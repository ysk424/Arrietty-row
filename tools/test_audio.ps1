...
$output=Join-Path $repo 'unreal/ArriettyRow/Saved/AudioCapture/row-audio-demo.wav'
$began=Get-Date
$arguments=@(('"'+$project+'"'),'/Game/Row/Maps/BledRow','-game','-RowDemo','-RowDemoStraight','-nohmd',
